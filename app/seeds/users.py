...
def seed_users():
    ...
    comparison_seed_data = [
        ...
        },
        {
            ...
            It has been considered one of the masterpieces of the Romantic movement and one of its most representative works. The painting has been widely interpreted as an emblem of self-reflection or contemplation of life's path, and the landscape is widely considered to evoke the sublime.
            """
        },
        {
            "user_id": 4,
        ...
        },
        {
            ...
            he bronze sculpture, in which Medusa's head turns men to stone, is appropriately surrounded by three huge marble statues of men: Hercules, David, and later Neptune.[2] Cellini's use of bronze in Perseus and the head of Medusa, and the motifs he used to respond to the previous sculpture in the piazza, were highly innovative. Examining the sculpture from the back, one can see a self-portrait of the sculptor Cellini on the back of Perseus' helmet.
            """
        },
        {
            "user_id": 5,
        ...
        },
        {
            ...
            "comparison_text": """
            A leading example of pointillist technique, executed on a large canvas, it is a founding work of the neo-impressionist movement. Seurat's composition includes a number of Parisians at a park on the banks of the River Seine. It is in the collection of the Art Institute of Chicago.
